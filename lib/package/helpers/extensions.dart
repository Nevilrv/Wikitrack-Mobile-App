...
import 'package:wikitrack/package/core/ripple_marker.dart';
import 'package:wikitrack/package/helpers/math_util.dart';
...
extension LatLngEx on Marker {
  ...
  LatLngInfo get toLatLngInfo => LatLngInfo.marker(this, ripple: isRipple);
}
...
extension LatLngInfoEx on LatLng {
  ...
  LatLngInfo get toDefaultLatLngInfo => LatLngInfo.position(this, MarkerId(''));
