...
import 'package:wikitrack/package/models/lat_lng_info.dart';
...
abstract class SphericalUtil {
  ...
  static Object interpolate(ILatLng from, ILatLng to, num fraction) {
  ...
  static LatLngInfo vectorInterpolate(ILatLng from, ILatLng to, double t) {
  ...
  static LatLngInfo vectorToPolar(Vector3 i) {
  ...
  static LatLngInfo vectorToPolarOptimized(Float32x4 vector) {
