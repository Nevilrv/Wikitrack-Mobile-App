...
//
//     final getStopTimeByRegNoResModel = getStopTimeByRegNoResModelFromJson(jsonString);

import 'dart:convert';

GetStopTimeByRegNoResModel getStopTimeByRegNoResModelFromJson(String str) =>
    GetStopTimeByRegNoResModel.fromJson(json.decode(str));

String getStopTimeByRegNoResModelToJson(GetStopTimeByRegNoResModel data) => json.encode(data.toJson());

class GetStopTimeByRegNoResModel {
  int? count;
  dynamic next;
  dynamic previous;
  List<Result>? results;

  GetStopTimeByRegNoResModel({
    this.count,
    this.next,
    this.previous,
    this.results,
  ...
  factory GetStopTimeByRegNoResModel.fromJson(Map<String, dynamic> json) => GetStopTimeByRegNoResModel(
        count: json["count"],
        next: json["next"],
